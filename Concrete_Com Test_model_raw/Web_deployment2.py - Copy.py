...
xgb_model2 = pickle.load(open(r'D:\INeuron_Projects\Concrete_Com Test Pred\xgb_model2.sav', 'rb'))
lgb_model2 = pickle.load(open(r'D:\INeuron_Projects\Concrete_Com Test Pred\lgb_model2.sav', 'rb'))
...
def main():
    ...
    if choice == "Home":
        ...
        with open(r'D:\INeuron_Projects\Concrete_Com Test Pred\model_development.ipynb', 'r') as f:
